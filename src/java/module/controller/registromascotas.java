 ...
 * @author adsi
 */
@WebServlet(name = "registromascotas", urlPatterns = {"/registromascotas"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            ...
            String dueño = request.getParameter("user");
            ...
            Logger.getLogger(registromascotas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
